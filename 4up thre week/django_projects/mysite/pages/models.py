...
class UserProfile(models.Model):
    ...
    def get_avatar_url(self):
        if self.avatar_choice == "custom" and self.avatar_url:
            return self.avatar_url
        
        cloud_name = settings.CLOUDINARY_CLOUD_NAME

        cloudinary_defaults = {
            "default1": f"https://res.cloudinary.com/{cloud_name}/image/upload/codequest/avatars/default1",
            "default2": f"https://res.cloudinary.com/{cloud_name}/image/upload/codequest/avatars/default2",
            "default3": f"https://res.cloudinary.com/{cloud_name}/image/upload/codequest/avatars/default3",
            "default4": f"https://res.cloudinary.com/{cloud_name}/image/upload/codequest/avatars/default4",
        }
        return cloudinary_defaults.get(self.avatar_choice, cloudinary_defaults["default1"])
