...
from .models import Submission,Post,Reply,UserProfile
...
def _normalize_submission_level(level):
    return _parent_level_for_topic(level) or level
...
def submit_solution(request):
    ...
    level = _normalize_submission_level(raw_level)
