...
define gui.accent_color = '#9FBDC4'

## 當文字按鈕既未被選取也未被懸停時所使用的顏色
define gui.idle_color = '#90c3fd'

## 小顏色適用於小文字，需要更亮/更暗才能達到與普通文字相同的效果
define gui.idle_small_color = '#bfedef'

## 用於懸停的按鈕和欄的顏色
define gui.hover_color = '#88aed9'

## 當文字按鈕被選取但未獲得焦點時所使用的顏色。如果按鈕是目前畫面或首選項值，則
## 按鈕將被選取
define gui.selected_color = '#cbc2ff'

## 無法選擇文字按鈕時使用的顏色
define gui.insensitive_color = '#6d2222ff'

## 顏色用於未填充的條形部分。這些顏色不直接使用，而是在重新生成條形影像檔案時使
## 用
define gui.muted_color = '#9091BF'
define gui.hover_muted_color = '#586b91'
